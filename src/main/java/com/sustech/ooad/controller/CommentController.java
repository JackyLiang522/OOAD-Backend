...
public class CommentController {
    ...
    @PostMapping("")
    public Comment add(Chapter chapter, String contents, int id, String nickname, int user_id, Date date){
        return commentService.addComment(chapter, contents, id, nickname, user_id, date);
    }
